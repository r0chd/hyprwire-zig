...
pub fn rc(alloc: Allocator, value: anytype) Allocator.Error!RcUnmanaged(@TypeOf(value)) {
    return RcUnmanaged(@TypeOf(value)).init(alloc, value);
}

pub fn arc(alloc: Allocator, value: anytype) Allocator.Error!ArcUnmanaged(@TypeOf(value)) {
